//
//  MyFavouriteListViewController.swift
//  DiscoverStreaming
//
...
class MyFavouriteListViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,CLLocationManagerDelegate,AVAudioPlayerDelegate {
   
    

    @IBOutlet weak var myfavoriteListTableview: UITableView!
    ...
    func FavsongListApi(){
          if !isCall
          {
              if Reachability.isConnectedToNetwork() == true{
                  ...
                  parameterDictionary.setValue(DataManager.getVal("favourite_song"), forKey: "list_type")
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if tableView == myfavoriteListTableview{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let  cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! MyFavoriteListCell
    ...
    @objc func HandleTap(_ sender:UIButton)
       {
           let nextview = Deletesongview.intitiateFromNib()
                  ...
                  let buttonPosition = sender.convert(CGPoint.zero, to: self.myfavoriteListTableview)
                  self.myindexpath = self.myfavoriteListTableview.indexPathForRow(at: buttonPosition)! as NSIndexPath
                  ...
                  if Reachability.isConnectedToNetwork() == true {
                    ...
                    let parameterDictionary = NSMutableDictionary()
                    parameterDictionary.setObject(DataManager.getVal(self.user_Id), forKey: "user_id" as NSCopying)
                    parameterDictionary.setValue(DataManager.getVal("favourite_song"), forKey: "remove_type")
                    parameterDictionary.setValue(DataManager.getVal(self.songId), forKey: "song_id")
                    parameterDictionary.setValue(DataManager.getVal(0), forKey: "playlist_id")
                    print(parameterDictionary)
