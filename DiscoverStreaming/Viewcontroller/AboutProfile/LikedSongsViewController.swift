...
class LikedSongsViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,CLLocationManagerDelegate,AVAudioPlayerDelegate {
    ...
    func LikedsongListApi(){
        if !isCall
        {
            if Reachability.isConnectedToNetwork() == true{
                ...
                parameterDictionary.setValue(DataManager.getVal("like_song"), forKey: "list_type")
...
//                    self.response.removeAllObjects()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! LikedSongCell
        ...
        cell.songDuaretionLbl.text = dict.value(forKey: "duration") as? String
    ...
    @objc func HandleTap(_ sender:UIButton){
        ...
        nextview.buttonDoneHandler = {
            let buttonPosition = sender.convert(CGPoint.zero, to: self.likedtableview)
            self.myindexpath = self.likedtableview.indexPathForRow(at: buttonPosition)! as NSIndexPath
            ...
            if Reachability.isConnectedToNetwork() == true {
                ...
                let parameterDictionary = NSMutableDictionary()
                parameterDictionary.setObject(DataManager.getVal(self.user_Id), forKey: "user_id" as NSCopying)
                parameterDictionary.setValue(DataManager.getVal("like_song"), forKey: "remove_type")
                parameterDictionary.setValue(DataManager.getVal(self.songId), forKey: "song_id")
