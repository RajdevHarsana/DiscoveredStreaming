//
//  AddSongStripeViewController.swift
//  DiscoverStreaming
//
//  Created by MAC-27 on 03/09/20.
...
class AddSongStripeViewController: UIViewController,STPPaymentCardTextFieldDelegate {
                      ...
                      DispatchQueue.main.async(execute: {
                          ...
                          if status == "0"{
                            ...
                            if self.delegate != nil{
                                self.delegate?.sendDataToFirstViewController(account_id: self.accountId, flag: true)
                                self.navigationController?.popViewController(animated: true)
                            }
