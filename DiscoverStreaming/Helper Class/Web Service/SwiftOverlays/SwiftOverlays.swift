...
open class SwiftOverlays: NSObject {
    ...
    static let backgroundColor = UIColor(red: 255, green: 255, blue: 255, alpha: 1.0)
    ...
    */
    ...
    open class func showCenteredWaitOverlay(_ parentView: UIView) -> UIView {
        ...
        ai.startAnimating()
        ai.color = UIColor(red: 255/255, green: 45/255, blue: 165/255, alpha: 1.0)
       // ai.backgroundColor = UIColor(red: 255/255, green: 45/255, blue: 165/255, alpha: 1.0)
        ai.backgroundColor = UIColor.clear
...
//            height: ai.frame.size.height * 2)
       ...
       // containerView.backgroundColor = UIColor(red: 255/255, green: 45/255, blue: 165/255, alpha: 1.0)
    ...
    @objc open class func removeAllOverlaysFromView(_ parentView: UIView) {
        var overlay: UIView?
